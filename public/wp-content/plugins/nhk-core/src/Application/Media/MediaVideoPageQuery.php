...
final class MediaVideoPageQuery
{
    ...
    private function video(Video $video): array { return ['id' => $video->canonicalId, 'title' => $video->title, 'platform' => $video->platform, 'external_id' => $video->externalVideoId, 'url' => $video->canonicalUrl, 'public_url' => PublicRouteResolver::videoPath($video->title, $video->externalVideoId)]; }
}

...
final class McpAbilityRegistration
{
    ...
    private const READ_TOOL_MAP = [
        ...
        'nhk.relationship.registry' => 'nhk-v3/relationship-registry',
        'nhk.relationship.list' => 'nhk-v3/relationship-list',
        'nhk.relationship.get' => 'nhk-v3/relationship-get',
        'nhk.relationship.preview' => 'nhk-v3/relationship-preview',
    ...
    private const GOVERNED_TOOL_MAP = [
        ...
        'nhk.video.source.refresh' => 'nhk-v3/video-source-refresh',
        'nhk.video.frontend.reconcile' => 'nhk-v3/video-frontend-reconcile',
        'nhk.media.ingest' => 'nhk-v3/media-ingest',
        'nhk.media.update' => 'nhk-v3/media-update',
        'nhk.media.bind' => 'nhk-v3/media-bind',
        'nhk.media.usage' => 'nhk-v3/media-usage',
    ...
    private static function label(string $tool): string
    {
        return [
            ...
            'nhk.capture.get' => 'NHK Capture Read-back',
            ...
            'nhk.media.update' => 'NHK Governed Media Metadata Repair',
            ...
            'nhk.video.frontend.reconcile' => 'NHK Video Frontend Reconciliation',

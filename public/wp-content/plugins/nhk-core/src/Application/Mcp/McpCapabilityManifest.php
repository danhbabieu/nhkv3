...
final class McpCapabilityManifest
{
    ...
    public static function all(): array
    {
        ...
        $definitions = [
            ...
            'video' => ['owner' => 'video', 'endpoint_types' => ['video'], 'tools' => ['nhk.video.get', 'nhk.video.ingest', 'nhk.video.source.refresh'], 'seo_preflight' => true, 'relation_support' => true, 'media_support' => true, 'read_back' => true],

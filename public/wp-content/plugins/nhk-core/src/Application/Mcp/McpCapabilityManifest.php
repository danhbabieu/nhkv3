...
final class McpCapabilityManifest
{
    ...
    public static function all(): array
    {
        ...
        $definitions = [
            'editorial_capture' => ['owner' => 'capture_wordpress', 'endpoint_types' => ['wp_post'], 'tools' => ['nhk.capture.ingest', 'nhk.capture.get'], 'seo_preflight' => true, 'relation_support' => true, 'media_support' => true, 'read_back' => true],
            ...
            'knowledge' => ['owner' => 'knowledge', 'endpoint_types' => ['knowledge'], 'tools' => ['nhk.knowledge.get', 'nhk.knowledge.writer.preview', 'nhk.knowledge.ingest'], 'seo_preflight' => false, 'relation_support' => true, 'media_support' => false, 'read_back' => true],
            ...
            'media' => ['owner' => 'media', 'endpoint_types' => ['media'], 'tools' => ['nhk.media.get', 'nhk.media.update', 'nhk.media.ingest', 'nhk.media.attachment.get'], 'seo_preflight' => true, 'relation_support' => true, 'media_support' => true, 'read_back' => true],
            'video' => ['owner' => 'video', 'endpoint_types' => ['video'], 'tools' => ['nhk.video.get', 'nhk.video.ingest', 'nhk.video.source.refresh', 'nhk.video.frontend.reconcile'], 'seo_preflight' => true, 'relation_support' => true, 'media_support' => true, 'read_back' => true],

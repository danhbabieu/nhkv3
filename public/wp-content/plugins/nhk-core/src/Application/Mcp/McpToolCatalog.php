...
final class McpToolCatalog
{
    ...
    public static function tools(): array
    {
        return [
            ...
            self::tool('nhk.media.upload-widget.open', 'Open the NHK image uploader UI. Upload results remain physical Media records until a canonical Capture flow reuses their Media IDs.', [], [], false, ['ui' => ['resourceUri' => 'ui://nhk/image-upload/v2.html', 'visibility' => ['model', 'app']]]),

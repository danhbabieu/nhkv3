...
final class ArticleRemediationPlanner
{
    ...
    /** @return list<string> */
    private function dependencies(string $code): array { $dependencies = []; if (in_array($code, ['MEDIAUSAGE_INCOMPLETE', 'ARTICLE_MEDIA_FEATURED_MISSING', 'ARTICLE_MEDIA_INLINE_MISSING', 'MEDIA_USAGE_SEMANTIC_MISMATCH'], true)) $dependencies[] = 'capture-child-admission'; if (in_array($code, ['SUBJECT_NOT_PERSISTED', 'SEMANTIC_READBACK_UNVERIFIED'], true)) $dependencies[] = 'governed-proposal'; return $dependencies; }

...
final readonly class PredicateDefinition {
    public function __construct(public string $key, public array $allowed_source_types, public array $allowed_target_types, public string $outbound_cardinality = 'MANY', public string $inbound_cardinality = 'MANY', public bool $allow_self_relation = false, public bool $active = true, public string $scope_notes = '', public string $evidence_requirement = 'OPTIONAL', public string $provenance_requirement = 'OPTIONAL', public string $public_projection_notes = '', public array $constraints = []) {

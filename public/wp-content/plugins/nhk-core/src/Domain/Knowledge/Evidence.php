...
{
    public function __construct(public string $canonicalId, public string $claimId, public string $sourceId, public string $relation = 'supports', public string $excerpt = '', public ?string $locator = null, public bool $active = true, public int $revision = 1)
    {

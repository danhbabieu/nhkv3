...
final class GovernanceMigration003
{
    ...
    public function up(): void
    {
        ...
        dbDelta("CREATE TABLE {$p}nhk_proposal_dependencies (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, proposal_id BIGINT UNSIGNED NOT NULL, dependency_uuid BINARY(16) NOT NULL, PRIMARY KEY (id), UNIQUE KEY proposal_dependency_unique (proposal_id,dependency_uuid), KEY dependency_lookup (dependency_uuid,proposal_id)) {$c}");

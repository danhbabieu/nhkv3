...
final class MediaMigration004
{
    ...
    public function up(): void
    {
        ...
        $definitions = [
            ...
            'nhk_media_usages' => "CREATE TABLE {$p}nhk_media_usages (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, usage_uuid BINARY(16) NOT NULL, media_id BIGINT UNSIGNED NOT NULL, endpoint_type VARCHAR(64) NOT NULL, endpoint_key VARCHAR(191) NOT NULL, usage_role VARCHAR(32) NOT NULL, sort_order INT UNSIGNED NOT NULL DEFAULT 0, alt_text VARCHAR(1000) NOT NULL DEFAULT '', caption TEXT NOT NULL, keyword_groups_json LONGTEXT NOT NULL, created_at DATETIME(6) NOT NULL, PRIMARY KEY (id), UNIQUE KEY usage_uuid_unique (usage_uuid), UNIQUE KEY media_usage_unique (media_id,endpoint_type,endpoint_key,usage_role), KEY endpoint_lookup (endpoint_type,endpoint_key,usage_role,id)) {$c}",

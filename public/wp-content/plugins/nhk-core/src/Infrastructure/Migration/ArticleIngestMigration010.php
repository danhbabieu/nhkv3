...
final class ArticleIngestMigration010
{
    ...
    public function up(): void
    {
        ...
        dbDelta("CREATE TABLE {$table} (id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT, operation_id CHAR(36) NOT NULL, idempotency_key VARCHAR(191) NOT NULL, request_fingerprint CHAR(64) NOT NULL, intent VARCHAR(24) NOT NULL, wp_endpoint_key VARCHAR(191) NULL, wp_post_id BIGINT UNSIGNED NULL, wp_state_token CHAR(64) NULL, dependency_map_json LONGTEXT NOT NULL, proposal_states_json LONGTEXT NOT NULL, apply_attempts_json LONGTEXT NOT NULL, stage VARCHAR(32) NOT NULL, outcome VARCHAR(64) NOT NULL, retryable TINYINT UNSIGNED NOT NULL DEFAULT 0, proposal_ids_json LONGTEXT NOT NULL, applied_proposal_ids_json LONGTEXT NOT NULL, failure_json LONGTEXT NOT NULL, diagnostics_json LONGTEXT NOT NULL, revision INT UNSIGNED NOT NULL DEFAULT 1, created_at DATETIME(6) NOT NULL, updated_at DATETIME(6) NOT NULL, PRIMARY KEY (id), UNIQUE KEY operation_unique (operation_id), UNIQUE KEY idempotency_unique (idempotency_key), KEY stage_outcome (stage,outcome,id), KEY wp_post_lookup (wp_endpoint_key,wp_post_id), KEY revision_lookup (operation_id,revision)) {$charset}");

...
final class PublicMediaVideoRoutes
{
    ...
    public function rewrite(): void { add_rewrite_rule('^video/page/([1-9][0-9]*)/?$', 'index.php?nhk_video_page=$matches[1]', 'top'); add_rewrite_rule('^video/([0-9A-Fa-f-]{36})/?$', 'index.php?nhk_video_key=$matches[1]', 'top'); add_rewrite_rule('^video/?$', 'index.php?nhk_video_page=1', 'top'); add_rewrite_rule('^(?:thu-vien|media)/?$', 'index.php?nhk_media_route=archive&nhk_media_page=1', 'top'); add_rewrite_rule('^media/([0-9A-Fa-f-]{36})/?$', 'index.php?nhk_media_route=detail&nhk_media_key=$matches[1]', 'top'); add_rewrite_rule('^media/page/([1-9][0-9]*)/?$', 'index.php?nhk_media_route=archive&nhk_media_page=$matches[1]', 'top'); }

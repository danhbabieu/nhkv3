...
{
    // Native wp-sitemap.xml remains independent from the Video sitemap.
    public function __construct(private VideoRepository $videos, private ?MigrationStatus $status = null, private ?PublicIdentityRepository $identities = null, private ?VideoUrlPolicy $policy = null)
    {
    }

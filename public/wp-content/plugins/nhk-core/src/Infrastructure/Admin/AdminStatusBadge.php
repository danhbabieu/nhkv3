...
final class AdminStatusBadge
{
    public static function render(string $label, string $state, ?string $reason = null): void
    {
        ...
        $labels = ['ready' => 'Sẵn sàng', 'applied' => 'Đã áp dụng', 'pending' => 'Đang chờ', 'blocked' => 'Bị chặn', 'unavailable' => 'Không khả dụng', 'empty' => 'Chưa có dữ liệu', 'complete' => 'Hoàn tất', 'partial' => 'Một phần', 'verified' => 'Đã xác minh', 'not_applicable' => 'Không áp dụng', 'submitted' => 'Đã gửi', 'approved' => 'Đã phê duyệt'];

...
final class AdminPage
{
    ...
    public static function render(): void
    {
        ...
        self::renderHealth((new HealthCheck($status))->read()); self::renderEntityLookup($status); self::renderProposalLookup($status);

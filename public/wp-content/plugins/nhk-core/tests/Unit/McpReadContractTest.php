...
{
    public function test_attachment_readback_keeps_inconsistent_mapping_distinct_from_not_found(): void
    {
        $reader = new class implements \NHK\Core\Contracts\Media\WordPressMediaAttachmentIngestor {
        ...
        $emptyAuthority = new InMemoryAuthorityRepository();
        $emptyMedia = new class implements MediaRepository {
        ...
        $emptyAssets = new class implements MediaAssetRepository {
        ...
        $emptyUsages = new class implements MediaUsageRepository {
        ...
        $emptyVideos = new class implements VideoRepository {
        ...
        $handler = new McpReadHandler($emptyAuthority, $types, $emptyMedia, $emptyAssets, $emptyUsages, $emptyVideos, $emptyClaims, $emptyEvidence, null, null, null, null, $reader);
    ...
    public function test_entity_read_adapter_is_non_mutating_and_type_safe(): void
    {
        ...
        self::assertArrayNotHasKey('thumbnail_media_id', $videoRead);
        self::assertArrayNotHasKey('active', $videoRead);

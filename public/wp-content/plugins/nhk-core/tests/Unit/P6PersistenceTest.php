...
final class P6PersistenceTest extends TestCase
{
    ...
    public function test_video_proposals_use_governance_executor_for_ingest_and_state_lifecycle(): void
    {
        ...
        $result = $executor(new Proposal('video-ingest-1', 'video', 'ingest', ['url' => 'https://youtu.be/9bZkp7q19f0', 'title' => 'Canonical video', 'metadata' => ['source' => ['platform' => 'youtube', 'external_video_id' => '9bZkp7q19f0', 'identity_valid' => true, 'availability' => 'available', 'embeddable' => true], 'source_rights' => 'PUBLIC_EXTERNAL_REFERENCE', 'editorial' => ['title' => 'Canonical video', 'summary' => 'Tóm tắt', 'body' => 'Nội dung'], 'embed_url' => 'https://www.youtube-nocookie.com/embed/9bZkp7q19f0']], 'content', 1, 'deps', ProposalState::APPROVED, '1', '2', null, 'idem-video-ingest', 1, null, null, null, 'video'));

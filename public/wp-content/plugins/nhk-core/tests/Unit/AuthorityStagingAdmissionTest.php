...
final class AuthorityStagingAdmissionTest extends TestCase
{
    ...
    private function fixture(): array
    {
        ...
        return [[
            ...
            'candidate_bindings' => [
                ['candidate_id' => 'candidate-831c785e8e84398ce3c7', 'entity_type' => 'model', 'operation' => 'create', 'subject_id' => 'model', 'target_uuid' => '', 'expected_revision' => null],
                ['candidate_id' => 'candidate-43e3d1452693c18a7119', 'entity_type' => 'relation', 'operation' => 'relation_create', 'subject_id' => '', 'source_type' => 'model', 'source_uuid' => '', 'source_revision' => 1, 'predicate' => 'model_of', 'target_type' => 'brand', 'target_uuid' => '01a090fd-9a71-7665-af5f-08f6e25b533e', 'target_revision' => 2, 'expected_revision' => null],
            ],
        ], $capture, ['authority_intent' => ['requests' => [['entity_type' => 'model', 'operation' => 'create', 'name' => 'Atherton', 'payload' => ['brand_uuid' => '01a090fd-9a71-7665-af5f-08f6e25b533e']]]]]];
    }
}

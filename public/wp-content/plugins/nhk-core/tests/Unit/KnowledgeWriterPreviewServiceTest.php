...
final class KnowledgeWriterPreviewServiceTest extends TestCase
{
    ...
    public function test_qualified_variant_name_does_not_promote_specialized_descendants_to_exact_identity(): void
    {
        $base = '88888888-1111-4111-8111-111111111111';
        $twoTune = '88888888-2222-4222-8222-222222222222';
        $aveMaria = '88888888-3333-4333-8333-333333333333';
        $this->authority->create(new AuthorityEntity($base, 'variant', 'variant:test.36.10', 'Đồng hồ Test 36/10', 1, []));
        $this->authority->create(new AuthorityEntity($twoTune, 'variant', 'variant:test.36.10.two-tune', 'Đồng hồ Test 36/10 hai bài', 1, []));
        $this->authority->create(new AuthorityEntity($aveMaria, 'variant', 'variant:test.36.10.ave-maria', 'Đồng hồ Test 36/10 Ave Maria', 1, []));
        $this->rows = [[
        ...
        self::assertSame(['base-claim'], array_column($result['used_knowledge'], 'claim_id'));
    }

...
?>
  <?php get_template_part('template-parts/presentation/breadcrumbs', null, ['items' => [['label' => $label, 'url' => (string) ($context['archive_url'] ?? home_url($archivePaths[$type] ?? '/'))], ['label' => (string) ($identity['name'] ?? '')]]]); ?>

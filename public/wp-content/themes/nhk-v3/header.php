...
<body <?php body_class(); ?>><?php wp_body_open(); ?><a class="skip-link" href="#main-content">Bỏ qua đến nội dung chính</a><header class="site-header"><div class="header-inner">
  ...
  <div class="header-actions"><nav class="nav" id="primary-navigation" aria-label="Điều hướng chính"><?php if (has_nav_menu('primary')) wp_nav_menu(['theme_location' => 'primary', 'container' => false, 'menu_class' => 'nav-list']); else nhk_v3_nav_fallback(); ?></nav>

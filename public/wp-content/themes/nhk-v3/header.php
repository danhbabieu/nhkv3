...
<body <?php body_class(); ?>><?php wp_body_open(); ?><a class="skip-link" href="#main-content">Bỏ qua đến nội dung chính</a><header class="site-header"><div class="header-inner">
  ...
  <input class="nav-toggle" type="checkbox" id="nav-toggle" aria-label="Mở menu điều hướng" aria-controls="primary-navigation" aria-haspopup="dialog" aria-expanded="false"><label class="nav-toggle-label" for="nav-toggle"><span></span><span></span><span></span><b class="screen-reader-text">Menu</b></label>
  <div class="header-actions"><nav class="nav" id="primary-navigation" aria-label="Điều hướng chính"><?php nhk_v3_nav_fallback(); ?></nav>

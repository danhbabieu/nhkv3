...
<?php if (is_array($context) && ($context['mode'] ?? '') === 'detail' && $media !== []): ?>
  ...
  <div class="media-detail-layout">
    ...
    <aside class="media-facts"><h2>Thông tin</h2><dl class="entity-facts"><dt>Mã hồ sơ</dt><dd><?php echo esc_html((string) ($media['stable_key'] ?? '')); ?></dd><dt>Trạng thái hiển thị</dt><dd><?php echo esc_html((string) ($media['readiness'] ?? '')); ?></dd><dt>Vị trí sử dụng</dt><dd><?php echo esc_html((string) count((array) ($media['usages'] ?? []))); ?></dd></dl></aside>
  </div>

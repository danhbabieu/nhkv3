...
| MCP catalog | Exactly 22 tools; governed writes remain capability-gated; eight existing read abilities are exposed on supported WordPress versions | IMPLEMENTED for current catalog | McpToolCatalog.php, McpAbilityRegistration.php, MCP_V3_CONTENT_OPERATIONS.md |

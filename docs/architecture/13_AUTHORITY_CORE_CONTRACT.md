...
Movement generation/type is part of the canonical Authority contract: see
[MOVEMENT_GENERATION_TYPE_CONTRACT.md](MOVEMENT_GENERATION_TYPE_CONTRACT.md).
It is represented by registered optional Movement attributes, not a new entity
or approval path.

...
Last updated: 2026-09-01, P11 public Entity list checkpoint.
...
| Tests | Unit suite: 125 tests, 760 assertions; guarded WordPress integration: 58 tests, 418 assertions; combined current suite: 183 tests, 1,178 assertions; Composer PHP lint, MCP wire smoke, route smoke 30/30 and diff check pass; browser public-language/SEO and responsive route sweep remains recorded below |

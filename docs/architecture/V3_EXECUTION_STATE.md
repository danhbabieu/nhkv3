...
Last updated: 2026-09-01, P11 Entity archive boundary checkpoint.
...
| Tests | Unit suite: 129 tests, 804 assertions; guarded WordPress integration: 59 tests, 425 assertions; combined current suite: 188 tests, 1,229 assertions; Composer PHP lint, MCP wire smoke, route smoke 30/30 and diff check pass; browser public-language/SEO and responsive route sweep remains recorded below |

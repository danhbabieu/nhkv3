...
Last updated: 2026-09-01, P11 public MediaAsset delivery-boundary checkpoint.
...
| Tests | Unit suite: 102 tests, 568 assertions; guarded WordPress integration: 47 tests, 362 assertions; combined current suite: 149 tests, 930 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

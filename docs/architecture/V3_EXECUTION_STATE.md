...
| Tests | Unit suite: 106 tests, 584 assertions; guarded WordPress integration: 49 tests, 370 assertions; combined current suite: 155 tests, 954 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

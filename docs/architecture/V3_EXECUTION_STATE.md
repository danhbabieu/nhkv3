...
| Tests | Unit suite: 111 tests, 674 assertions; guarded WordPress integration: 52 tests, 384 assertions; combined current suite: 164 tests, 1,058 assertions; plugin/theme PHP lint, route smoke 29/29, browser public-language/SEO sweep and diff check pass |

...
Last updated: 2026-09-01, P11 Governance proposal checkpoint.
...
| Tests | Unit suite: 134 tests, 840 assertions; guarded WordPress integration: 69 tests, 434 assertions; combined current suite: 203 tests, 1,274 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
| Tests | Unit suite: 90 tests, 483 assertions; guarded WordPress integration: 44 tests, 347 assertions (latest complete run); combined latest complete suite: 134 tests, 827 assertions before the alias-contract assertions; current unit contract, plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

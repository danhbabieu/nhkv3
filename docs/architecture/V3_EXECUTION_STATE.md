...
| Tests | Unit suite: 129 tests, 803 assertions; guarded WordPress integration: 59 tests, 425 assertions; combined current suite: 188 tests, 1,228 assertions; Composer PHP lint, MCP wire smoke, route smoke 30/30 and diff check pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
Last updated: 2026-09-01, P11 Video discovery-boundary checkpoint.
...
| Tests | Unit suite: 125 tests, 760 assertions; guarded WordPress integration: 57 tests, 414 assertions; combined current suite: 182 tests, 1,174 assertions; Composer PHP lint, MCP wire smoke, route smoke 30/30 and diff check pass; browser public-language/SEO and responsive route sweep remains recorded below |

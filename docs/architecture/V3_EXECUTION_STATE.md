...
Last updated: 2026-09-01, P11 editorial archive SEO checkpoint.
...
| Tests | Unit suite: 111 tests, 692 assertions; guarded WordPress integration: 56 tests, 391 assertions; combined current suite: 167 tests, 1,083 assertions; plugin/theme PHP lint, route smoke 30/30, browser public-language/SEO sweep and diff check pass |

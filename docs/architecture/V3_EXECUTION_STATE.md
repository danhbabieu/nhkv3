...
| Tests | Unit suite: 94 tests, 535 assertions; guarded WordPress integration: 44 tests, 349 assertions; combined current suite: 138 tests, 884 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

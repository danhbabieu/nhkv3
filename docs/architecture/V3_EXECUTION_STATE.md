...
Last updated: 2026-09-01, P11 public URL validation checkpoint.
...
| Tests | Unit suite: 110 tests, 665 assertions; guarded WordPress integration: 50 tests, 380 assertions; combined current suite: 161 tests, 1,045 assertions; plugin/theme PHP lint, route smoke 29/29, browser public-link sweep and diff check pass |

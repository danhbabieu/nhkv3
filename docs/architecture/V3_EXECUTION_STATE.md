...
Last updated: 2026-09-01, P11 public language boundary checkpoint.
...
| Tests | Unit suite: 109 tests, 652 assertions; guarded WordPress integration: 50 tests, 380 assertions; combined current suite: 160 tests, 1,032 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |
...
- 2026-09-01: Public relation, search, comparison and Knowledge type labels
  ...
  no overflow. Unit 109/652, guarded integration 50/380, combined PHPUnit
  160/1,032, lint and route smoke 29/29 passed.

...
Last updated: 2026-09-01, P11 public UI boundary checkpoint.
...
| Tests | Unit suite: 109 tests, 648 assertions; guarded WordPress integration: 50 tests, 380 assertions; combined current suite: 160 tests, 1,028 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

...
| Tests | Unit suite: 95 tests, 540 assertions; guarded WordPress integration: 44 tests, 352 assertions; combined current suite: 139 tests, 892 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

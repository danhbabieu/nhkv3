...
Last updated: 2026-09-01, P11 normalized Source type migration checkpoint.
...
| Tests | Unit suite: 107 tests, 589 assertions; guarded WordPress integration: 50 tests, 385 assertions; combined current suite: 157 tests, 974 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

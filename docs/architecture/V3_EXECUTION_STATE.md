...
Last updated: 2026-09-01, P11 MediaAsset privacy boundary checkpoint.
...
| Tests | Unit suite: 140 tests, 846 assertions; guarded WordPress integration: 69 tests, 434 assertions; combined current suite: 209 tests, 1,280 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
| Tests | Unit suite: 152 tests, 916 assertions; guarded WordPress integration: 94 tests, 512 assertions; combined current suite: 246 tests, 1,428 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
| Tests | Unit suite: 140 tests, 846 assertions; guarded WordPress integration: 74 tests, 447 assertions; combined current suite: 214 tests, 1,293 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
| Tests | Unit suite: 143 tests, 856 assertions; guarded WordPress integration: 89 tests, 479 assertions; combined current suite: 232 tests, 1,335 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
Last updated: 2026-09-01, P11 Source/Evidence archived-state checkpoint.
...
| Tests | Unit suite: 107 tests, 589 assertions; guarded WordPress integration: 51 tests, 388 assertions; combined current suite: 158 tests, 977 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

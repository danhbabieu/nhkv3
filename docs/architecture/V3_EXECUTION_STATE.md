...
| Tests | Unit suite: 91 tests, 491 assertions; guarded WordPress integration: 44 tests, 347 assertions; combined current suite: 135 tests, 838 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

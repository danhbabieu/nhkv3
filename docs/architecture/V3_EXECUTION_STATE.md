...
| Tests | Guarded WordPress suite: 176 tests, 1,143 assertions; Composer PHP lint, MCP wire smoke, route smoke 30/30 and diff check pass; browser public-language/SEO and responsive route sweep remains recorded below |

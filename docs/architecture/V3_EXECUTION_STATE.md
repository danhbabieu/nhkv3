...
| Tests | Unit suite: 148 tests, 904 assertions; guarded WordPress integration: 92 tests, 506 assertions; combined current suite: 240 tests, 1,410 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

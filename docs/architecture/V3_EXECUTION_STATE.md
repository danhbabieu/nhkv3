...
Last updated: 2026-09-01, P11 public document-language checkpoint.
...
| Tests | Unit suite: 112 tests, 699 assertions; guarded WordPress integration: 55 tests, 391 assertions; combined current suite: 167 tests, 1,090 assertions; plugin/theme PHP lint, route smoke 30/30, browser public-language/SEO sweep and diff check pass |

...
| Tests | Unit suite: 111 tests, 683 assertions; guarded WordPress integration: 56 tests, 391 assertions; combined current suite: 167 tests, 1,074 assertions; plugin/theme PHP lint, route smoke 30/30, browser public-language/SEO sweep and diff check pass |

...
Last updated: 2026-09-01, P11 repository race-safety checkpoint.
...
| Tests | Unit suite: 134 tests, 831 assertions; guarded WordPress integration: 65 tests, 436 assertions; combined current suite: 199 tests, 1,267 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
| Tests | Unit suite: 148 tests, 906 assertions; guarded WordPress integration: 93 tests, 509 assertions; combined current suite: 241 tests, 1,415 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
Last updated: 2026-09-01, P11 Authority UUID boundary checkpoint.
...
| Tests | Unit suite: 135 tests, 841 assertions; guarded WordPress integration: 69 tests, 434 assertions; combined current suite: 204 tests, 1,275 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

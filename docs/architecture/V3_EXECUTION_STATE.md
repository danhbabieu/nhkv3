...
| Tests | Unit suite: 141 tests, 852 assertions; guarded WordPress integration: 87 tests, 476 assertions; combined current suite: 228 tests, 1,328 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

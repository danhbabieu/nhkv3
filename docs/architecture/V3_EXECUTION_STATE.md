...
Last updated: 2026-09-01, P11 design-token parity checkpoint.
...
| Tests | Unit suite: 109 tests, 620 assertions; guarded WordPress integration: 50 tests, 380 assertions; combined current suite: 159 tests, 1,000 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |
...
- 2026-09-01: Theme CSS now has one warm NHK design-token source and no
  ...
  remains overflow-free. Unit 109/620, guarded integration 50/380, combined
  PHPUnit 159/1,000, lint and route smoke 29/29 passed.

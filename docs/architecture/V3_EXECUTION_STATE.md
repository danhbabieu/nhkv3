...
| Tests | Unit suite: 117 tests, 732 assertions; guarded WordPress integration: 57 tests, 403 assertions; combined current suite: 174 tests, 1,135 assertions; plugin/theme PHP lint, MCP wire smoke, route smoke 30/30, browser public-language/SEO sweep and diff check pass |

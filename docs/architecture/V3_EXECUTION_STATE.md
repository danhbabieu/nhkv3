...
| Tests | Unit suite: 98 tests, 555 assertions; guarded WordPress integration: 45 tests, 355 assertions; combined current suite: 143 tests, 910 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

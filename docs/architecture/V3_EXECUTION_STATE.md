...
| Tests | Unit suite: 149 tests, 887 assertions; guarded WordPress integration: 93 tests, 500 assertions; combined current suite: 242 tests, 1,387 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

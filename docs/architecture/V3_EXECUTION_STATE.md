...
| Tests | Unit suite: 111 tests, 678 assertions; guarded WordPress integration: 56 tests, 391 assertions; combined current suite: 167 tests, 1,069 assertions; plugin/theme PHP lint, route smoke 29/29, browser public-language/SEO sweep and diff check pass |

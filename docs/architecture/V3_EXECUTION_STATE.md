...
Last updated: 2026-09-01, P11 Source/Evidence migration-parity checkpoint.
...
| Tests | Unit suite: 107 tests, 589 assertions; guarded WordPress integration: 49 tests, 383 assertions; combined current suite: 156 tests, 972 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

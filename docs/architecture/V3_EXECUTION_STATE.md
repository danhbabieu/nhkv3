...
| Tests | Unit suite: 147 tests, 883 assertions; guarded WordPress integration: 91 tests, 494 assertions; combined current suite: 238 tests, 1,377 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

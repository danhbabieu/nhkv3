...
| Tests | Unit suite: 109 tests, 621 assertions; guarded WordPress integration: 50 tests, 380 assertions; combined current suite: 159 tests, 1,001 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

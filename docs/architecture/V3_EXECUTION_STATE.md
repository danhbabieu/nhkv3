...
Last updated: 2026-09-01, P11 Media publication-safety checkpoint.
...
| Tests | Unit suite: 134 tests, 825 assertions; guarded WordPress integration: 59 tests, 425 assertions; combined current suite: 193 tests, 1,250 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

...
Last updated: 2026-09-01, P11 editorial accessibility checkpoint.
...
| Tests | Unit suite: 111 tests, 670 assertions; guarded WordPress integration: 50 tests, 380 assertions; combined current suite: 162 tests, 1,050 assertions; plugin/theme PHP lint, route smoke 29/29, browser homepage/link sweep and diff check pass |

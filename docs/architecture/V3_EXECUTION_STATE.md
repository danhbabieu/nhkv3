...
Last updated: 2026-09-01, P11 Graph REST public-boundary checkpoint.
...
| Tests | Unit suite: 104 tests, 580 assertions; guarded WordPress integration: 49 tests, 370 assertions; combined current suite: 153 tests, 950 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

...
Last updated: 2026-09-01, P11 migration dry-run evidence checkpoint.
...
| Tests | Unit suite: 116 tests, 716 assertions; guarded WordPress integration: 56 tests, 396 assertions; combined current suite: 172 tests, 1,112 assertions; plugin/theme PHP lint, route smoke 30/30, browser public-language/SEO sweep and diff check pass |

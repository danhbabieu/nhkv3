...
| Tests | Unit suite: 146 tests, 877 assertions; guarded WordPress integration: 90 tests, 489 assertions; combined current suite: 236 tests, 1,366 assertions; Composer PHP lint, MCP wire smoke, all-nine-type core route smoke 34/34 and opt-in real Authority detail route smoke 41/41 pass; browser public-language/SEO and responsive route sweep remains recorded below |

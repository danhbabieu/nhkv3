...
Last updated: 2026-09-01, P11 Source/Evidence fail-closed checkpoint.
...
| Tests | Unit suite: 107 tests, 589 assertions; guarded WordPress integration: 49 tests, 382 assertions; combined current suite: 156 tests, 971 assertions; plugin/theme PHP lint, route smoke 29/29 plus two data-gated detail redirects and diff check pass |

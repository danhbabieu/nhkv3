...
| URLs | 800 | 697 | 697 | 103 | 0 | 0 | 697 | 292 Knowledge claim UUID redirects, 370 Authority entity redirects, 34 native-post redirects and one identical source/target `READY_NOOP`; residual skips are 80 `DOMAIN_TARGETED` and 23 invalid mappings |

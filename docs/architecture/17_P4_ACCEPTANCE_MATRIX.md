...
| P4-APPLY-001 | Transaction, row lock, rollback, failure and retry | `P4ControlledApplyIntegrationTest::test_failure_rolls_back_authority_persists_failed_attempt_and_retry_is_successful` | INTEGRATION | PASS/PARTIAL | Real DB rollback/retry passes; concurrent apply and race coverage pending |

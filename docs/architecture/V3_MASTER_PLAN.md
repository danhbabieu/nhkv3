...
| P10 V2 → V3 Data Migration | IN PROGRESS | Versioned V2 normalize/export, guarded backup/restore, Migration006 ledger, Migration007 Evidence metadata, Migration008 MediaAsset metadata/visibility, governed native-post URL redirects and resumable apply are implemented; local-dev checkpoint imported 1,642 rows including field-level PRIVATE MediaAsset metadata, 34 URL redirects and Source/Evidence citation rows, while unmapped URLs/usages/projections and domain-targeted posts remain gated. |

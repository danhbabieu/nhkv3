...
| P10 V2 → V3 Data Migration | IN PROGRESS | Versioned V2 normalize/export, guarded backup/restore, Migration006 ledger, Migration007 Evidence metadata, Migration008 MediaAsset metadata/visibility, governed native-post/entity/Knowledge URL redirects and resumable apply are implemented; local-dev checkpoint imported 2,304 rows including field-level PRIVATE MediaAsset metadata, 292 Knowledge redirects, 370 entity redirects, 34 native-post redirects and Source/Evidence citation rows, while 103 URL candidates, media usages, projections and domain-targeted posts remain gated. |

...
| P9 Frontend/UI parity | IN PROGRESS | Responsive NHK editorial theme with canonical entity archive/detail routes; related modules and runtime smoke QA pending. |

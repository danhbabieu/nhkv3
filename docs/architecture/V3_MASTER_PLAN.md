...
| P10 V2 → V3 Data Migration | IN PROGRESS | Versioned V2 normalize/export, guarded backup/restore, Migration006 ledger, Migration007 Evidence metadata and resumable apply are implemented; local-dev checkpoint imported 1,607 rows including MediaAsset metadata plus Source/Evidence citation rows, while URLs/usages/projections and domain-targeted posts remain gated. |

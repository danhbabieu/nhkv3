...
| P10 V2 → V3 Data Migration | IN PROGRESS | Source-level V3 route inventory and granular no-write dry-run reconciliation tooling added; V2 export, backup/restore evidence, URL ledger and real migration remain gated. |

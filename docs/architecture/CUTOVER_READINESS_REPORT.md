...
- Theme design tokens now have one NHK source; the legacy token/rule block was
  removed, contract coverage checks all 11 required tokens, and cache-busting
  browser verification confirms no legacy tokens or horizontal overflow.

...
| Search / empty search | Read-only route/behavior inventory recorded | Unified semantic search | Posts plus canonical entities, media, videos and knowledge | PARTIAL — blank/whitespace search now fails closed with zero semantic cards, avoiding empty-term enumeration |

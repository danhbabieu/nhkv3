...
is 94 tests / 512 assertions and combined coverage is 243 tests / 1,422
assertions. Video migration and dry-run now canonicalize supported YouTube URL
forms and record URL/external-ID disagreement as a reason-coded conflict before
persistence.
